    ...
    <div class="card shadow px-3 mt-4">
        ...
        <div class="mt-3">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="mb-3">
                        <span class="me-1" style="font-weight: bold;">Expected Delivery Date: </span> <span>{{$entry->expected_delivery?dateToString($entry->expected_delivery  ):'n/a'}}</span>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="mb-3">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    @foreach($items as $item)
                        <tr>
                            ...
                            <td scope="col">{{$item->itemEntity->name}}</td>
