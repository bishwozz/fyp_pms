...
<form id="salesForm" action="{{url($crud->route).'/'.$sales->id}}" method="PUT">
        ...
        <div class="row mt-3">
            ...
            <div class="col-xl-4 col-md-4 col-sm-6">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="bill_no" readonly value="{{$sales->bill_no}}" placeholder="Bill No">
                </div>
                <div class="input-group mb-3">
    ...
    <table class="table" style="min-width: 1200px">
        ...
        <tbody id="sales-table">
            ...
            <tr>
                ...
                <td>
                    <div class="input-group">
                        ...
                        <select class="form-select p-1 salesBatchNo" name="batch_no[{{$key}}]" id="salesBatchNo-{{$key}}" size="1" data-cntr="{{$key}}">
                ...
                <td class="{{($sales->status_id==2)?'d-none':''}}">
                    <div class="input-group">
                        <input type="text" class="form-control p-1 salesBatchQty" value="{{$batchQty->batch_qty}}" name="batch_qty[{{$key}}]" id="salesBatchQty-{{$key}}" data-cntr="{{$key}}" readonly value="" size="1" />
                </td>
                </div>
                <td style="max-width:3rem">
                    <div class="input-group" >
                        <input type="number" min="0" class="form-control p-1 salesAddQty"  size="1" value="{{$item->total_qty}}" {{$item->barcodeDetails->count() ? "readonly='true'" :'' }} name="total_qty[{{$key}}]" id="salesAddQty-{{$key}}" placeholder="Qty" size="1" data-cntr="{{$key}}"{{$multiple_barcode?'readonly':''}}>
                        @if($multiple_barcode)
                        <button type="button" class="btn btn-primary btn-sm barcodeScan" id="barcodeScan-{{$key}}" data-cntr="{{$key}}" data-toggle="modal">+</button>
                        @endif
                    </div>
                </td>
                <td>
            ...
            <tr class="d-none" id="repeater">
                ...
                <td>
                    <div class="input-group">
                        <input class="form-control p-1 salesBatchQty" type="text" value=""  size="1" readonly />
                    </div>
                </td>
                <td>
                    <div class="input-group">
                        <input type="text" class="form-control p-1 salesAddQty" placeholder="Qty" size="1" {{$multiple_barcode?'readonly':''}}>
                        @if($multiple_barcode)
        ...
        <div class="row">
            <div class="col-xl-4 col-md-6">
                ...
                <div class="cheque_enabled">
                    <div id="bank_field" class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" value="{{$sales->bank_name}}" name="bank_name" id="bank_name">
                    </div>

                    <div id="cheque_field" class="input-group mb-3">
                        <label class="input-group-text" for="cheque_number">Cheque Number</label>
                        <input type="text" class="form-control" value="{{$sales->cheque_number}}" name="cheque_number" id="cheque_number">
                    </div>
                    <div id="acc_holder_field" class="input-group mb-3">
                        <label class="input-group-text" for="ac_holder_name">Ac.Holder Name</label>
                        <input type="text" class="form-control" value="{{$sales->ac_holder_name}}" name="ac_holder_name" id="ac_holder_name">
                    </div>
                </div>
                <div class="input-group mb-3">
            ...
            <div class="col-xl-4 col-md-6">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" id="receipt_amount" disabled="true" value="{{$sales->receipt_amt}}" class="form-control" name="receipt_amt" placeholder="Amount">
                </div>
                ...
                <div class="cheque_enabled">
                    <div id="branch_field" class="input-group mb-3">
                        ...
                        <input type="text" id="branch_name" class="form-control" name="branch_name" value="{{$sales->branch_name}}" placeholder="Branch Name">
                    </div>

                    <div id="" class="input-group mb-3">
                        <span class="input-group-text">Cheque Date</span>
                        <input type="date" id="cheque_date" class="form-control" value="{{$sales->cheque_date}}" name="cheque_date">
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                <table class="table table-sm table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <input id="sl_paid_amount" type="text" name="paid_amt" value="{{$sales->paid_amt}}" class="form-control"></td>
                        </tr>
                        <tr id="sl_due_amt_field">
                        <th class="bg-primary text-white">Due</th>
                            <td> <input id="sl_due_amount" readonly type="text" value="{{$sales->due_amt}}" name="due_amt" class="form-control"></td>
                        </tr>
    ...
    <div class="container mb-4">
      ...
      @if($sales->status_id ==2)<button id="cancel" class="btn btn-danger cancel_approved">Cancel this bill</button>
