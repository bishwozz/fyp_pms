...
@php
    ...
    $column['icon'] = $column['value'] != false
        ? ($column['icons']['checked'] ?? 'fa-times-circle text-danger')
        : ($column['icons']['unchecked'] ?? 'fa-check-circle text-success');

    $column['text'] = $column['value'] != false
        ? ($column['labels']['unchecked'] ?? trans('backpack::crud.yes'))
        : ($column['labels']['checked'] ?? trans('backpack::crud.no'));
