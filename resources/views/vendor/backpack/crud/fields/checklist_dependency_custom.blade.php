...
@include('crud::fields.inc.wrapper_start')
    ...
    <div class="container">
      ...
      <div class="row">
          ...
          @php
           $secondary_entity = $secondary_dependency['option'] ?? $secondary_dependency['model']::all();
            $permission_collection= [];
            foreach($secondary_entity as $item){
                    ...
                    <div class="col-sm-2">
                        <div class="checkbox">
                            <label class="font-weight-normal">
                                ...
                                @endforeach
                                value="{{ $key }}"
                                    @if( ( isset($field['value']) && is_array($field['value']) && (  in_array($key, $field['value'][1]->pluck('id', 'id')->toArray()) || isset( $secondary_ids[$key])) || ( old($secondary_dependency['name']) &&   in_array($key, old($secondary_dependency['name'])) )))
                                        checked = "checked"
