...
@php
    if (!isset($field['options'])) {
        ...
        $fields['district_hidden_id']['attributes']['id'];
        // dd($fields);
        $district_hidden_id = $fields['district_hidden_id']['attributes']['id'];
        // $district_hidden_id = '';
        // dd($district_hidden_id);
        if(isset($district_hidden_id)){
            // $options = $field['model']::whereIn('district_id', $district_hidden_id)->get();
