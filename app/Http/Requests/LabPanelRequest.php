...
class LabPanelRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            'code' => 'required|max:20|unique:lab_panels,code'.$code_check,
            'name' => 'required|max:200|unique:lab_panels,name'.$name_check,
    ...
    public function messages()
    {
        return [
            ...
            'lab_category_id.required' => 'Lab category is required.',
            'charge_amount.integer' => 'Charge Amount must be a number.',
